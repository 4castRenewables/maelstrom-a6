...
if __name__ == "__main__":
    parser = lifetimes.cli.training.create_hdbscan_parser()
    ...
    hyperparameters = lifetimes.studies.HyperParameters(
    ...
    clusters = lifetimes.studies.perform_pca_and_hdbscan_hyperparameter_study(
        data=data,
