srun apptainer run \
    ...
    --nv \
    /p/project/hclimrep/emmerich1/a6-cuda.sif \
    torchrun \
    ...
    --data-path /p/project/hclimrep/emmerich1/data/deepclusterv2/daily \
    --nmb-crops 2 \
    --size-crops 96 \
    ...
    --final-lr 0.05 \
    --arch resnet50 \
    --dump-path /p/scratch/hclimrep/emmerich1/dcv2/dump
